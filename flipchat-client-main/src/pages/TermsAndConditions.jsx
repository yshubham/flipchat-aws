      ...
      <div className="landing-section">
          ...
          <div className="landing-container">
            <div className="landing-features-head terms-header">
              ...
              <h3 className="landing-features-title">
                FLIPCHAT TERMS OF SERVICE
              </h3>
            </div>
            <div className="landing-features-body">
              <div className="terms-sub-block">
                <h3 className="terms-sub-header">OVERVIEW</h3>
                <p className="terms-sub-para">
                  This website is operated by{" "}
                  <span className="terms-bold-span">Flipchat Inc</span>.
                  Throughout the site, the terms “we”, “us” and “our” refer to{" "}
                  <span className="terms-bold-span">Flipchat Inc</span> .{" "}
                  <span className="terms-bold-span">Flipchat Inc</span> offers
        ...
        <section className="terms-section">
          <div className="landing-container">
            <div className="landing-features-body">
              ...
              <div className="terms-sub-block">
                <h3 className="terms-sub-header">SECTION 7 - OPTIONAL TOOLS</h3>
                <p className="terms-sub-para">
                ...
                <p className="terms-sub-para">
                  We shall have no liability whatsoever arising from or relating
          ...
          <div className="landing-container">
            <div className="landing-features-body">
              ...
              <div className="terms-sub-block">
                ...
                <p className="terms-sub-para">
                  In no case shall{" "}
                  <span className="terms-bold-span">Flipchat Inc</span>, our
              ...
              <div className="terms-sub-block">
                ...
                <p className="terms-sub-para">
                  ...
                  <span className="terms-bold-span">Flipchat Inc</span> and our
              ...
              <div className="terms-sub-block">
                <h3 className="terms-sub-header">SECTION 15 - SEVERABILITY</h3>
                <p className="terms-sub-para">
        ...
        <section className="landing-pricing">
          <div className="landing-container">
            <div className="landing-features-body">
              <div className="terms-sub-block">
                <h3 className="terms-sub-header">SECTION 16 - TERMINATION</h3>
                <p className="terms-sub-para">
              ...
              <div className="terms-sub-block">
                <h3 className="terms-sub-header">SECTION 18 - GOVERNING LAW</h3>
                <p className="terms-sub-para">
              ...
              <div className="terms-sub-block">
                ...
                <p className="terms-sub-para">
                  ...
                  <span className="terms-bold-span">support@flipchat.link</span>
                </p>
              </div>
            </div>
          </div>
